...
# Elastic Export Guenstiger.de Plugin for plentymarkets 7

This is the elastic export Guenstiger.de plugin for plentymarkets 7 which extends the list of possible export formats.
